export default [
  {
    ...
    answers: [
      ...
      { id: 'a2', text: 'A library for managing state in web applications.' },
      {
        id: 'a3',
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'a2', text: 'Creating responsive layouts in React applications.' },
      { id: 'a3', text: 'Handling errors within the application.' },
      {
        id: 'a4',
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'a2', text: 'By defining a custom HTML tag in JavaScript.' },
      { id: 'a3', text: 'By creating a file with a .jsx extension.' },
      {
        id: 'a4',
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'a2', text: 'The lifecycle phase a React component is in.' },
      {
        id: 'a3',
  ...
  },
  {
    ...
    answers: [
      { id: 'a1', text: 'Using the #if template syntax.' },
      { id: 'a2', text: 'Using a ternary operator.' },
